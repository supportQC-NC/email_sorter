...
#         if rule['field'] == "Sujet":
#             text = subject.lower()
#         elif rule['field'] == "Expéditeur":
#             text = from_addr.lower()
#         elif rule['field'] == "Destinataire":
#             text = to_addr.lower()
#         else:  # Corps
#             text = body.lower()
...
#         if rule['condition'] == "contient":
#             return keyword in text
#         elif rule['condition'] == "commence par":
#             return text.startswith(keyword)
#         elif rule['condition'] == "finit par":
#             return text.endswith(keyword)
#         elif rule['condition'] == "est exactement":
#             return text == keyword
